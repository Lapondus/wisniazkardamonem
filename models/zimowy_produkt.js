...
const ZimowyProduktSchema = new Schema({                                      //tworzę nowy szablon (przedstawia wygląd danych w danym dokumencie)
    nazwa: String,
...
ZimowyProduktSchema.post('findOneAndDelete', async function (doc) {                   //middleware ale dla mongoose a nie express skomplikowane jeszcze bardziej, to akurat służy usunięciu komentarzy przy usunięciu produktu
...
module.exports = mongoose.model('ZimowyProdukt', ZimowyProduktSchema)               //tworze model, co równoznaczne jest z utworzeniem kolekcji Model--> models